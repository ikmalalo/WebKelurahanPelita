      ...
      <main className="md-main">
        <div className="md-content">
          ...
          <article className="md-article">
            ...
            <p className="md-text" style={{ marginTop: '40px', textAlign: 'center', fontWeight: '600', color: '#8b5cf6', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
              Sekarang Anda siap membuat konten promosi kelas dunia. Selamat berkreasi!
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.21 1.21 0 0 0 1.72 0L21.64 5.36a1.21 1.21 0 0 0 0-1.72Z"/><path d="m14 7 3 3"/><path d="M5 6v4"/><path d="M19 14v4"/><path d="M10 2v2"/><path d="M7 8H5"/><path d="M21 16h-2"/><path d="M11 3H9"/></svg>
            </p>
          </article>
        </div>
